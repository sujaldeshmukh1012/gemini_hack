        ...
        <div className="min-h-screen bg-gradient-to-br from-surface-50 via-primary-50/20 to-secondary-50/20 flex">
            ...
            <div className="flex-1 flex flex-col justify-center px-6 py-12 lg:px-8">
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    {/* Header */}
                    <h1 className="text-3xl font-black text-surface-900 mb-2">{t('auth.createAccount')}</h1>
                    <p className="text-lg text-surface-600 font-medium mb-10">{t('auth.startJourney')}</p>
                </div>
                ...
                <div className="sm:mx-auto sm:w-full sm:max-w-md">
                    ...
                    <p className="text-center text-base text-surface-700 font-medium">
                        {t('auth.haveAccount')}{' '}
                        <Link to="/login" className="font-bold text-primary-600 hover:text-primary-700 cursor-pointer transition-colors duration-150">
                            {t('auth.signIn')}
                        </Link>
                    </p>
